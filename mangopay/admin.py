...
from mangopay.models import MangoPayUser, MangoPayDocument, MangoPayPage, MangoPayBankAccount, MangoPayWallet, MangoPayTransfer, MangoPayRefund, MangoPayPayIn, MangoPayCardRegistration, MangoPayCard, MangoPayPayOut, MangoPayBankAccount, MangoPayPage, MangoPayDocument, MangoPayWallet
...
class MangoPayPayIntAdmin(admin.ModelAdmin):

    list_display = ('mangopay_id', 'mangopay_user', 'mangopay_wallet', 'mangopay_card', 'status', )


admin.site.register(MangoPayPayIn, MangoPayPayIntAdmin)
